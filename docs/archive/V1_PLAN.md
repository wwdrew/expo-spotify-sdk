> **Archived:** This document records the v1/v2 implementation plan. The plan is complete — **`1.0.0`** and **`2.0.0`** shipped the full Auth + App Remote API. Kept for historical context only. For current docs see [README.md](../../README.md) and [CONTEXT.md](../../CONTEXT.md).
...
**Status:** **`main` = Expo SDK 56 / `2.x`** (Phase 7 complete; **`2.0.0`** shipped). **`v1` branch = SDK 55 / `1.x`** (`1.0.0` on npm). Source of truth for per-method status: the [Coverage matrix](#5-coverage-matrix). Historical QA checklist: [QA_CHECKLIST.md](../QA_CHECKLIST.md).
